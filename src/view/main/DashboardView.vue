<template>
  <div class="container mx-auto grid grid-cols-3 gap-6">
    <div
      v-for="(item, i) in dashAll"
      :key="i"
      class="bg-white py-7 pl-5 rounded-md flex gap-4 items-center justify-start"
    >
      <svg :fill="item.iconColor" width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <rect width="48" height="48" rx="12" fill-opacity="0.1" />
        <path
